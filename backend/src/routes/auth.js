    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                accessToken = (0, token_management_js_1.createAccessToken)({ id: user.id, role: user.role });
                refreshToken = (0, token_management_js_1.createRefreshToken)({ id: user.id, role: user.role });
